...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Косметология</h2>
            </div>
        </div>

        <div class="row">
            <ul id="gallery-grid" class="gallery-grid col-sm-12">
                <c:forEach items="${kosmList}" var="kosm">
                    <li>
                        <a href="/" data-largesrc="example/gallery/01.jpg" data-title="Project Name 1" data-description="data-description">
                            <img src="${kosm.image}" alt=""/>
                        </a>
                        <h3>${kosm.name}</h3>
                        <div class="portfolio_description">
                            <div class="block">
                                <h3>${kosm.name}</h3>
                                <p class="description">${kosm.description}</p>
                                <p class="client"><span>Мастер:</span> <a href="#">${kosm.masterEntity.name}</a></p>
                                <p class="location"><span>Цена:</span>${kosm.price} руб</p>
                                <form action="addKosm" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${kosm.id}" id="addKosmID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addKosm" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
