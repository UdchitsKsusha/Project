    ...
    <div class="container">
        ...
        <div class="row">
            <div class="block col-sm-6">
                <form modelAttribute="editInfo" class="contact-form" method="post" action="editInfo">
                    ...
                    <p class="contact-form-submit vertical-margin-40">
                        <input type="submit" value="Изменить" id="contact_form_submit" name="contact_submit" class="theme_btn">
