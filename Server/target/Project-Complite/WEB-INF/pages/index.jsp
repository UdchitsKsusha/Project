    ...
    <c:forEach items="${authorisationObject}" var="ro">
        <c:if test="${ro.returnString == 'User'}">
            <div class="container">
                <div class="col-md-9" data-animate="fadeInDown">
                    <ul class="menu">
                        <li class="icons__item" data-toggle="modal">
...
<section id="mainslider" class="color_section bg_image gradient">
    <div class="flexslider">
        <ul class="slides">
            <li>
                <img src="example/flex_slide01.jpg" alt="" />
                <div class="slide_description_wrapper">
                    <div class="slide_description">
                        <h4 data-animation="slideInDown">Добро пожаловать!</h4>
                        <h2 data-animation="bounce">Selfie</h2>
                        <h3 data-animation="fadeInLeft">Cалон красоты</h3>
                        <p data-animation="fadeInRight">
                            <a class="theme_btn" href="about">Узнать больше</a>
                        </p>
                    </div>
                </div>
            </li>
