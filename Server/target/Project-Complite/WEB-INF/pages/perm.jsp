...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Перманентный макияж</h2>
            </div>
        </div>
                ...
                <c:forEach items="${permList}" var="perm">
                    <li>
                        <a href="/" data-largesrc="example/gallery/01.jpg" data-title="Project Name 1" data-description="data-description">
                            <img src="${perm.image}" alt=""/>
                        </a>
                        <h3>${perm.name}</h3>
                        <div class="portfolio_description">
                            <div class="block">
                                <h3>${perm.name}</h3>
                                <p class="description">${perm.description}</p>
                                <p class="client"><span>Мастер:</span> <a href="#">${perm.masterEntity.name}</a></p>
                                <p class="location"><span>Цена:</span>${perm.price} руб</p>
                                <form action="addPerm" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${perm.id}" id="addPermID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addPerm" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
