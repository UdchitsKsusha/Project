...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Эпиляция/депиляция</h2>
            </div>
        </div>

        <div class="row">
            <ul id="gallery-grid" class="gallery-grid col-sm-12">
                <c:forEach items="${depilList}" var="depil">
                <li>
                    <a href="/" data-largesrc="example/gallery/01.jpg" data-title="Project Name 1" data-description="data-description">
                        <img src="${depil.image}" alt=""/>
                    </a>
                    <h3>${depil.name}</h3>
                    <div class="portfolio_description">
                        <div class="block">
                            <h3>${depil.name}</h3>
                            <p class="description">${depil.description}</p>
                            <p class="client"><span>Мастер:</span> <a href="#">${depil.masterEntity.name}</a></p>
                            <p class="location"><span>Цена:</span>${depil.price} руб</p>
                            <form action="addDepil" method="post">
                                <p class="view-project">
                                    <input type="hidden" value="${depil.id}" id="addDepilID" name="id" class="theme_btn">
                                    <input type="submit" value="Записаться" id="addDepil" name="submit" class="theme_btn">
                                </p>
                            </form>
                        </div>
                    </div>
