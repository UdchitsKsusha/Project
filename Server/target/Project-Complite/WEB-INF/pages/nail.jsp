...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Уход за ногтями</h2>
            </div>
        </div>

        <div class="row">
            <ul id="gallery-grid" class="gallery-grid col-sm-12">
                <c:forEach items="${nailList}" var="nail">
                    <li>
                        ...
                        <div class="portfolio_description">
                            <div class="block">
                                <h3>${nail.name}</h3>
                                <p class="description">${nail.description}</p>
                                <p class="client"><span>Мастер:</span>${nail.masterEntity.name}</p>
                                <p class="location"><span>Цена:</span>${nail.price} руб</p>
                                <form action="addNail" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${nail.id}" id="addNailID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addNail" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
