...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">SPA уход</h2>
            </div>
        </div>
                ...
                <c:forEach items="${spaList}" var="spa">
                    <li>
                        ...
                        <div class="portfolio_description">
                            <div class="block">
                                <h3>${spa.name}</h3>
                                <p class="description">${spa.description}</p>
                                <p class="client"><span>Мастер:</span> <a href="#">${spa.masterEntity.name}</a></p>
                                <p class="location"><span>Цена:</span>${spa.price} руб</p>
                                <form action="addSpa" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${spa.id}" id="addSpaID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addSpa" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
