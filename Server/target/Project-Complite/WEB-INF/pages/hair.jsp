                            ...
                            <c:forEach items="${information}" var="inf">
                                ...
                                <div class="cart">
                                    <form action="editInformation" method="post">
                                        <input type="hidden" value="${inf.serviceEntity.id}" id="11submit" name="id" class="theme_btn">
                                    ...
                                    <form action="deleteInformation" method="post">
                                        <input type="hidden" value="${inf.serviceEntity.id}" id="22submit" name="idS" class="theme_btn">
...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Уход за волосами</h2>
            </div>
        </div>
                    ...
                    <li>
                        ...
                        <div class="portfolio_description">
                            <div class="block">
                                ...
                                <p class="client"><span>Мастер:</span> <a href="#">${hair.masterEntity.name}</a></p>
                                <p class="location"><span>Цена:</span>${hair.price} руб</p>
                                <form action="addHair" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${hair.id}" id="addHairID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addHair" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
