...
<div id="top">
                    ...
                    <ul class="menu">
                        <li class="icons__item">
                            <form action="exit" method="post">
                                <input class="log" type="submit" value="Выйти" id="contact_form_submit1" name="contact_submit">
                            </form>
                        </li>
    ...
    <section id="contact" class="color_section parallax gradient">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2 class="block-header" data-animation="slideExpandUp">Запись на услугу</h2> 
                </div>
            </div>
            <div class="row">
                <div class="block col-sm-6">
                    <form modelAttribute="addInformation" class="contact-form" method="post" action="addInformation">
                        ...
                        <p class="contact-form-message">
                            <label for="message">Укажите удобное для Вас время</label>
                            <textarea aria-required="true" rows="8" cols="45" name="message" id="message" class="form-control" placeholder="Укажите удобное для Вас время, мы обязательно свяжемся для уточнения деталей"></textarea>
                        </p>
                        <p class="contact-form-submit vertical-margin-40">
                            <input type="submit" value="Записаться" id="contact_form_submit" name="contact_submit" class="theme_btn">
                            <form method="post" action="back">
                                <a href="gallery"><input type="back" value="Отмена" id="contact_form_reset" name="contact_submit" class="theme_btn inverse"></a>
                            </form>
                            </p>
                    </form>
                </div>
