...
<section id="middle" class="grey_section">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h2 class="block-header">Макияж и прически</h2>
            </div>
        </div>

        <div class="row">
            <ul id="gallery-grid" class="gallery-grid col-sm-12">
                <c:forEach items="${makeupList}" var="makeup">
                    <li>
                        <a href="/" data-largesrc="example/gallery/01.jpg" data-title="Project Name 1" data-description="data-description">
                            <img src="${makeup.image}" alt=""/>
                        </a>
                        <h3>${makeup.name}</h3>
                        <div class="portfolio_description">
                            <div class="block">
                                <h3>${makeup.name}</h3>
                                <p class="description">${makeup.description}</p>
                                <p class="client"><span>Мастер:</span> <a href="#">${makeup.masterEntity.name}</a></p>
                                <p class="location"><span>Цена:</span>${makeup.price} руб</p>
                                <form action="addMakeup" method="post">
                                    <p class="view-project">
                                        <input type="hidden" value="${makeup.id}" id="addMakeupID" name="id" class="theme_btn">
                                        <input type="submit" value="Записаться" id="addMakeup" name="submit" class="theme_btn">
                                    </p>
                                </form>
                            </div>
                        </div>
